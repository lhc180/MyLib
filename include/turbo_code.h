 ...
 *   class TurboCode
 *
 * Last Updated: <2014/05/09 14:16:17 from dr-yst-no-pc.local by yoshito>
 ************************************************************************************/
...
namespace mylib{
  ...
  protected:
    ...
    // マルチスレッド用
    virtual void CalcAlpha(itpp::vec *alpha, const itpp::vec &gamma, int branchNum, int nodeNum) const;
    virtual void CalcBeta(itpp::vec *beta, const itpp::vec &gamma, int branchNum, int nodeNum) const;
